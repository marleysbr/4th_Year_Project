<?php 
	...
	mysql_select_db($database, $linkID) or die("Could not find database."); 
        ...
        $query = "SELECT ChurchImage.imageID, ChurchImage.churchID, ChurchImage.filePath, Church.name FROM ChurchImage INNER JOIN Church ON ChurchImage.churchID = Church.churchID";
