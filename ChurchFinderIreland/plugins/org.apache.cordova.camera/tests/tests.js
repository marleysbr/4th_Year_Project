...
exports.defineManualTests = function (contentEl, createActionButton) {
    ...
    function readFile() {
        ...
        // ChurchFinderIreland out onFileReceived when the file object was set via a native <input> elements.
        if (fileObj) {
    ...
    function getFileInfo() {
        // ChurchFinderIreland FileEntry API here.
    ...
    var info_div = '<h1>Camera</h1>' +
        ...
        test_procedure = '<h4>Recommended ChurchFinderIreland Procedure</h4>' +
